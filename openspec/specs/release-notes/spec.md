...
## Purpose
Defines how release notes are generated and published for each tagged release, and how the app links to them from the Settings drawer and the PWA update toast.
