...
This hue assignment SHALL be scoped to the wedges only and SHALL NOT be applied to the reference-key text label or any other note-name text in the application.
